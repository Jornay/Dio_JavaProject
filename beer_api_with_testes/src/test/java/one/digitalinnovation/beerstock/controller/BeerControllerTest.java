...
public class BeerControllerTest {
    ...
    @Test
    void whenPostCreatedSuccessful() throws Exception {
    ...
    @Test
    void whenPostHaveEmptyFields() throws Exception {
    ...
    @Test
    void whenGETHaveValidName() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETHaventValidName() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETListIsValid() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETListIsEmpty() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenDeleteHaveValidId() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenDeleteHaventValidId() throws Exception {
